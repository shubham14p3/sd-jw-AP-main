              ...
              <div className="crancy-chatbox__inner">
                <div className="crancy-chatbox__author crancy-chatbox__email">
                  ...
                  {/* <div className="crancy-chatbox__author-content">
                    ...
                    <p className="crancy-chatbox__author-meta">
                      <span>By </span>{" "}
                      {emailItem.data.emailDetails.date[0]}
                    </p>
                  </div> */}
                  <div className="crancy-chatbox__author-content">
                    <h4 className="crancy-chatbox__author-title"></h4>
                    <p className="crancy-chatbox__author-meta">
                      <span>By {emailItem.data.emailDetails.from[0]}</span>
                    </p>
                    <p className="crancy-chatbox__author-meta">
                      <span>{emailItem.data.emailDetails.subject[0]}</span>
                    </p>
                    <p className="crancy-chatbox__author-meta">
                      <span>
                        {formatDate(emailItem.data.emailDetails.date[0])}
                      </span>
                    </p>
                  </div>
                </div>
                <div className="crancy-chatbox__right crancy-chatbox__right__message">
                  <span
                    className={`crancy-chatbox__stared ${
                      emailItem.isImportant ? "" : "crancy-chatbox__stared--no"
                    } `}
                  >
                    <i
                      className={`${
                        emailItem.isImportant ? "fa" : "fa-regular"
                      } fa-star`}
                    ></i>
                  </span>
                  <div className="crancy-chatbox__toggle">
